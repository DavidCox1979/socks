...
*/
class PhpStats_TimeInterval_DayValuesTest extends PhpStats_TimeInterval_DayTestCase
{
    ...
    function testWhenUncompactedAndUncompactedQueriesDisabled()
    {
        ...
        $this->assertEquals( array(), $day->describeAttributesValues(), 'should return empty array when not compacted, and uncompacted queries are disabled' );
    }
    ...
    function testConstrainByAnotherAttributeChildrenHoursCompacted()
    {
        ...
        $day = new PhpStats_TimeInterval_Day( $this->getTimeParts(), array( 'b' => 2 ), false, false );
